...
base_url = "https://www.hospitalhealth.org"
...
endpoints = {
    ...
    "provideridsforkeywords": "/api/sitecore/vendor/ProviderIdsForKeywords",
    "vendorSearch": "/api/sitecore/vendor/search",
...
print("Starting API test on hospitalhealth.org...")
